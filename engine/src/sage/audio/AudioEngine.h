...
public:
    ...
    // Пауза ОДНОГО управляемого звука (луп, музыка, источник сцены). Отдельно
    // от StopSound, потому что «продолжить с того же места» и «начать заново» —
    // разные вещи, и источник звука в сцене умеет и то, и другое.
