...
void ScriptEngine::RegisterPhysicsApi() {
    ...
    m_lua.set_function("OverlapSphere", [this](const glm::vec3& center, float radius,
    ...
    m_lua.set_function("Collisions", [this]() -> sol::table {
        sol::table list = m_lua.create_table();
        if (!m_physics) return list;
        int i = 1;
    ...
    // склоне.
    m_lua.set_function("AddCharacterController", [](GameObject& obj, sol::optional<float> radius,
    ...
    m_lua.set_function("MoveCharacter", [this](GameObject& obj, const glm::vec3& velocity,
                                               float dt) {
    ...
    m_lua.set_function("IsGrounded", [](GameObject& obj) -> bool {
        if (!obj.Valid()) return false;
        auto* cc = obj.Registry()->try_get<CharacterControllerComponent>(obj.Entity());
        return cc && cc->Grounded;
    });
    m_lua.set_function("GroundNormal", [](GameObject& obj) -> glm::vec3 {
    ...
    m_lua.set_function("SetCharacterPosition", [this](GameObject& obj, const glm::vec3& pos) {
        if (!obj.Valid() || !m_physics) return;
        auto* cc = obj.Registry()->try_get<CharacterControllerComponent>(obj.Entity());
    ...
    m_lua.set_function("SetPhysicsLayer", [](GameObject& obj, unsigned layer) {
        if (!obj.Valid()) return;
    ...
    m_lua.set_function("SetSensor", [](GameObject& obj, bool on) {
        if (!obj.Valid()) return;
        if (auto* rb = obj.Registry()->try_get<RigidBodyComponent>(obj.Entity())) {
            rb->Sensor = on;
