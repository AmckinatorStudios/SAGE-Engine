...
//
// ЧЕМ ЭТО ОТЛИЧАЕТСЯ ОТ ПРЕЖНЕГО. Раньше весь интерфейс был одним компонентом
// UIElementComponent на сорок с лишним полей и перечислением видов (панель,
// надпись, картинка, полоса, значок, поле, галка, ползунок). Такой компонент
