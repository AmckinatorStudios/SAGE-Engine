...
struct Skeleton {
    ...
    // пару узлов с поворотом (смена Z-up на Y-up у 3D-редактора, корневая обёртка у
...
// CUBICSPLINE, экспорт 3D-редактор с кривыми Безье), и кривая там задана не только
