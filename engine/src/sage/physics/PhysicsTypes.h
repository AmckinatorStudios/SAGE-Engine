...
struct CharacterDesc {
    ...
    // Зазор, на который тело «не доезжает» до поверхности. Контакт, считаемый
    // ровно на границе, даёт то проваливание на волосок, то зацеп за стык двух
    // плит — и то и другое выглядит как «персонаж дёргается на ровном полу».
    //
    // 0 — взять собственное значение мотора (kSkin). Так описание, собранное
    // кодом, который о зазоре ничего не знает, не сдвигает персонажа на
    // сантиметры относительно проверенного поведения.
