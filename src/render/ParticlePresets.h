...
// ---------------------------------------------------------------------
// ParticlePresets — готовые ParticleEmitterConfig под конкретные эффекты
// The Boat. Держим их отдельно от игровой логики (в render/, не в game/),
// потому что это чисто визуальные рецепты — не про правила игры, а про
// то, как это должно выглядеть. Игровой код (main.cpp/PlayerActions)
// просто вызывает нужный пресет в нужный момент.
// ---------------------------------------------------------------------
