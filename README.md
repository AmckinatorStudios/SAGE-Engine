...
> (ECS/RHI/редактор) на месте, но движок ещё не прошёл боевого тестирования на
> реальной игре — `games/sandbox` полезен как минимальный showcase и CI-fixture,
> но сознательно не нагружает движок всерьёз (нет теней/пост-процесса/моделей/
> аудио в реальном сценарии, нет нескольких сцен). Это следующий шаг перед тем,
> как говорить о стабильном релизе — см. `games/testgame`, когда появится.
