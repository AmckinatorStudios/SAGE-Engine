...
constexpr TranslationPair kRussianStrings[] = {
    ...
    {"Air",
     "Воздух"},
    {"Air of the scene: linear distance fog or exponential height fog as in Unreal",
     "Воздух сцены: линейный туман по расстоянию или высотный экспоненциальный, как в Unreal"},
    {"Albedo",
     "Альбедо"},
    {"Align",
     "Выравнивание"},
    ...
    {"Off — the horizon colour goes down to the nadir.\nOn — its own colour below the horizon (the deep blue\nvoid of Minecraft).",
     "Выключено — цвет горизонта до самого низа.\nВключено — свой цвет ниже горизонта (тёмно-синяя\n«пустота» Minecraft)."},
    ...
    {"The largest whole number that fits the reference screen: pixel art stays crisp (like Minecraft's GUI scale). 0 — no limit",
     "Наибольшее целое, при котором опорный экран помещается в окно: пиксельная графика остаётся чёткой (как «масштаб интерфейса» Minecraft). 0 — без предела"},
