...
bool Shape(const Pen& p, const char* n) {
    ...
    if (is("wire")) {
        ...
        p.Line(0.125f, 0.8125f, 0.5f, 0.1875f, 0.055f);
        p.Line(0.5f, 0.1875f, 0.875f, 0.8125f, 0.055f);
        p.Line(0.125f, 0.8125f, 0.875f, 0.8125f, 0.055f);
        return true;
    }
    ...
    if (is("physics")) {
        p.Disc(0.5f, 0.5f, 0.1875f);
        p.FillRect(0.125f, 0.8125f, 0.875f, 0.875f);
        p.Line(0.3125f, 0.125f, 0.3125f, 0.25f, 0.055f);
        p.Line(0.6875f, 0.125f, 0.6875f, 0.25f, 0.055f);
        return true;
    }
    ...
    if (is("file")) {
        p.Rect(0.25f, 0.125f, 0.75f, 0.875f, 0.075f, 0.05f);
        p.Line(0.5625f, 0.125f, 0.75f, 0.3125f, 0.06f);
        return true;
    }
    // Сцена: объекты на земле. Раньше это была та же картинка в рамке, что и
    // текстура, — два разных ассета выглядели одинаково.
    if (is("scene")) {
        p.Line(0.125f, 0.75f, 0.875f, 0.75f, 0.07f);
        p.Rect(0.1875f, 0.4375f, 0.4375f, 0.75f, 0.07f);
        p.Circle(0.6875f, 0.625f, 0.1875f, 0.07f);
        return true;
    }
    if (is("material")) { p.Circle(0.5f, 0.5f, 0.3125f); p.Disc(0.4375f, 0.375f, 0.09f); return true; }
    if (is("project")) {
    ...
    if (is("warn"))  { p.Tri(0.5f, 0.125f, 0.125f, 0.8125f, 0.875f, 0.8125f); return true; }
    if (is("error")) { p.Disc(0.5f, 0.5f, 0.375f); return true; }
    if (is("info"))  {
    ...
    if (is("debug")) {
        p.Circle(0.5f, 0.5f, 0.25f, 0.075f);
        p.Line(0.25f, 0.5f, 0.125f, 0.5f, 0.06f);
        p.Line(0.75f, 0.5f, 0.875f, 0.5f, 0.06f);
        p.Line(0.5f, 0.25f, 0.5f, 0.125f, 0.06f);
        p.Line(0.5f, 0.75f, 0.5f, 0.875f, 0.06f);
        return true;
    }
    ...
    if (is("open")) {
        p.FillRect(0.125f, 0.1875f, 0.4375f, 0.3125f, 0.03f);
        p.Rect(0.125f, 0.25f, 0.875f, 0.75f, 0.075f, 0.05f);
        p.Line(0.125f, 0.5625f, 0.875f, 0.5625f, 0.055f);
        return true;
    }
    if (is("plus")) {
