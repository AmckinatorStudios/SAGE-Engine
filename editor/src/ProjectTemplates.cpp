...
//
// «СТАРТЕРА ИНТЕРФЕЙСА» ЗДЕСЬ БОЛЬШЕ НЕТ. Он давал сцену с камерой, светом и
// двумя готовыми экранами — то есть ту же демо-сцену, только с другим набором
// чужих объектов, которые первым делом удаляют. Экраны интерфейса собираются в
// редакторе интерфейса из пустого проекта ровно теми же движениями, а лишний
// пункт в списке заставлял выбирать между двумя почти одинаковыми ответами на
